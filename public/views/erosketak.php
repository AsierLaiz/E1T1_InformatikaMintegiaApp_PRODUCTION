                        ...
                        <div class="card-body p-0">
                            ...
                            <ul class="nav nav-tabs erosketak flex-column flex-md-row tab-list-custom" id="myTab">
                                ...
                                <li class="btn-inferior-erosketak flex-md-fill">
                                    <button class="nav-link rounded-top-3 px-4" id="tab-opcion3" data-bs-toggle="tab" data-bs-target="#content-opcion3">
                                        <i class="fa-solid fa-table-list me-1"></i> Sortu Kategoria
                                    </button>
                                </li>
                            </ul>
                            ...
                            <div class="tab-content p-3 p-md-5 radius-inferior-5" id="myTabContent">
                                ...
                                <div class="tab-pane fade" id="content-opcion3" aria-labelledby="tab-opcion3">
                                    <h5 class="text-dark mb-4 border-bottom pb-2"><i class="fa-solid fa-plus ms-1"></i> Kategoria</h5>
                                    <form method="post" action="#">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="izena_kategoria" placeholder="Idatzi izena...">
                                            <label for="izena_kategoria">Izena</label>
                                        </div>
